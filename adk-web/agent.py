...
root_agent = LlmAgent(
    ...
    Your goal is to understand the user’s request, extract the task (intent), determine what kind of permission (consent) is needed, and delegate the task securely to the right calendar agent. Your job includes:
